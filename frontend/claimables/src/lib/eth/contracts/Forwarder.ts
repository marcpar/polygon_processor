...
class Forwarder extends Wrapper {
    constructor(address: string, runner?: ContractRunner) {
        super(address, abi, runner);
    }

    public async getNonce(address: string, batchId: number): Promise<number> {
        return Number((await this._contract.getNonce(address, batchId)));
    }
}
